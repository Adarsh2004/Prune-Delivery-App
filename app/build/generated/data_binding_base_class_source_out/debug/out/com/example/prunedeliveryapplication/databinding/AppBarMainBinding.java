...
public final class AppBarMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Switch switchBttn;

  @NonNull
  public final Toolbar toolbar;

  private AppBarMainBinding(@NonNull LinearLayout rootView, @NonNull Switch switchBttn,
      @NonNull Toolbar toolbar) {
    this.rootView = rootView;
    this.switchBttn = switchBttn;
  ...
  public static AppBarMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.switch_bttn;
      Switch switchBttn = ViewBindings.findChildViewById(rootView, id);
      if (switchBttn == null) {
        break missingId;
      }
      ...
      return new AppBarMainBinding((LinearLayout) rootView, switchBttn, toolbar);
    }
